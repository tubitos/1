...
namespace Aren
{
	...
	public class PickingScreen : IScene
	{
		...
		protected override void LoadContent (PloobsEngine.Engine.GraphicInfo GraphicInfo, PloobsEngine.Engine.GraphicFactory factory, IContentManager contentManager)
		{
			...
			//{
			//    SimpleModel sm = new SimpleModel (factory, "Models//cenario");
			...
			//    for (int j = 0; j < 10; j++)
			//    {
			//        SimpleModel sm = new SimpleModel (factory, "Models//cubo");
			...
			{
				SimpleModel sm = new SimpleModel (factory, "Models//Landscape");
				IPhysicObject po = new TriangleMeshObject (sm, Vector3.Zero, Matrix.Identity, Vector3.One, MaterialDescription.DefaultBepuMaterial ());
				IObject obj = new IObject (mat, sm, po);
				obj.Name = "Landscape";
				this.World.AddObject (obj);
			}

			{
				SimpleModel sm = new SimpleModel (factory, "Models//PLAY");
				BoxObject bo = new BoxObject (new Vector3 (0.0F, 10.0F, 0.0F), 1.0F, 1.0F, 1.0F, 1.0F, Vector3.One, Matrix.Identity, MaterialDescription.DefaultBepuMaterial ());
				IObject obj = new IObject (mat, sm, bo);
				obj.Name = "BoxPlay";
				this.World.AddObject (obj);
			}

			{
				SimpleModel sm = new SimpleModel (factory, "Models//QUIT");
				BoxObject bo = new BoxObject (new Vector3 (1.0F, 10.0F, 1.0F), 1.0F, 1.0F, 1.0F, 1.0F, Vector3.One, Matrix.Identity, MaterialDescription.DefaultBepuMaterial ());
				IObject obj = new IObject (mat, sm, bo);
				obj.Name = "BoxQuit";
				this.World.AddObject (obj);
			}
